...
export const Slyder = ({ slides }) => {
  return (
    ...
    >
        ...
        <div className="container relative flex justify-between border-0 rounded-2xl bg-blue2 mx-auto px-4 overflow-hidden">
                    ...
                    <div className="lg:ml-10 xl:ml-[5.62rem] mt-10 space-y-5 z-10">
                      ...
                      <p className="font-bold text-[2rem] lg:text-[3.9rem] leading-none text-white1">{slide.name}</p>
                      <p className="font-semibold text-[1.2rem] lg:text-[1.9rem] leading-none text-white1">{slide.discont}</p> 
                    </div>
