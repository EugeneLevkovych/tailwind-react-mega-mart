...
export default function Footer() {
  return (
    <div className="relative bg-main-blue overflow-hidden">
      <div
        className="absolute -top-30 -right-40 size-100 border border-blue3 rounded-full"
        style={{
      ...
      <div className="container pt-20 pb-7.5 mx-auto px-4">
        <div className="flex flex-wrap justify-center lg:flex-nowrap lg:justify-between lg:pr-10 xl:pr-47">
          <div>
            ...
            <p className="font-bold text-xl leading-none text-white mb-5">
              Contact Us
            </p>
            <div className="flex gap-3 w-41 h-10.5 mb-5 cursor-pointer">
              ...
              <p className="whitespace-pre-line font-medium leading-[1.25] text-white">
                {'Whats App\n+1 202-918-2132'}
              </p>
            </div>
            ...
            <div className="flex gap-3 w-41 h-10.5 mb-7.5 cursor-pointer">
              ...
              <p className="font-medium leading-[1.25] text-white">
                Call Us <br />
                +1 202-918-2132
              </p>
            </div>
        ...
        <p className="text-center text-xl leading-none text-white border-t border-blue3 pt-5">
